...
export default function About() {
    return <div className='flex flex-col md:flex-row bg-slate-950 p-8 pt-20 gap-9 md:gap-9 items-top'>
        <div className='grow border-b-sky-300 border-b-2'>
            <p className={`${jbm.className} text-slate-300 text-sm`}> -&gt; 01.</p>
            <h1 className={`${jbm.className} text-sky-300 text-5xl`}>Overview </h1>
        </div>
        <div className='w-full md:w-2/3 flex flex-col gap-2'>
            <h1 className={`${jbm.className} text-sky-300 font-bold text-lg`}>About Us</h1>
            <p>
            ...
            <h1 className={`${jbm.className} text-sky-300 font-bold text-lg`}>Location</h1>
            <p>
            ...
            <h1 className={`${jbm.className} text-sky-300 font-bold text-lg`}>Lunch</h1>
            <p>
                We will be selling cheese and pepperoni pizza for $2 a slice. Please pay in cash or by check during registration.
            </p>
            <h1 className={`${jbm.className} text-sky-300 font-bold text-lg`}>Test Guidelines</h1>
            <p>
